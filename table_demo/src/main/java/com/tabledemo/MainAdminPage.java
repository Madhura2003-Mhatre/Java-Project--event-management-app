...
public class MainAdminPage extends Application {
    ...
    public void start(Stage stage) throws ExecutionException, InterruptedException {
        ...
        ImageView logo = new ImageView(new Image("images/CompanyLogo.png"));
        ...
        HBox topBox = new HBox(40, logo, pageTitle);
        ...
        Tab tab4 = new Tab("Bookings"); // New tab for Events
        ...
        BookingsTableView eventsTableView = new BookingsTableView(); // Instantiate BookingsTableView
        VBox tab4Content = eventsTableView.eventsTableVBox(); // Get the VBox for the Events table
